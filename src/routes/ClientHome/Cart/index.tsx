...
export default function Cart() {
  ...
  /*Fez um pedido, pega o carrinho, vai casar os items com o corpo da requisição, se der certo limpa o carrinho e zera a contagem de items*/
  function handlePlaceOrderClick(){
   orderService.newOrderRequest(cart)
     .then(response => {
